# MissionBoard Backend Implementation Specification
...
- Database: PostgreSQL for missions, tasks, agents, evidence, reviews, decisions.
- Queue: Mission compile, status sync, evidence packaging jobs.
...
1. Create project for agent mission control.
...
- Worker can complete the primary agent mission control workflow using sample inputs.
