...
- Name: MissionBoard
- Category: Agent Task Board / Mission Control
- Summary: A mission control board that turns goals into missions, tasks, owners, status, evidence, review, approval, and decision logs.
- Priority: Phase 3 / Top 5 long-term
...
- Make MissionBoard understandable to public GitHub visitors without requiring private Cerebra context.
...
The person who runs MissionBoard to create or inspect the target artifact. They need clear setup, fast feedback, and usable output.
...
- Output must match the Agent Task Board / Mission Control use case.
...
Main risk areas: status theater, stale evidence, unclear ownership, weak approval model, overloaded mission scope
...
- a new user can understand MissionBoard from README.md
