# MissionBoard Environment And Configuration
...
PORT=4315
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/missionboard
APP_BASE_URL=http://localhost:4315
...
OBJECT_STORAGE_BUCKET=missionboard-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
